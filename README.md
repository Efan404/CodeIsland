...
It connects to **10 AI coding tools** via Unix socket IPC, displaying session status, tool calls, permission requests, and more — all in a compact, pixel-art styled panel.

## Features

- **Notch-native UI** — Expands from the MacBook notch, collapses when idle
- **10 AI tools supported** — Claude Code, Codex, Gemini CLI, Cursor, Copilot, Qoder, Factory, CodeBuddy, OpenCode, Kimi Code CLI
...
| | <img src="Sources/CodeIsland/Resources/cli-icons/trae.png" width="16"> Trae | 10 | IDE | Full |
...
| | <img src="Sources/CodeIsland/Resources/cli-icons/stepfun.png" width="16"> StepFun | 10 | IDE | Full |
| | <img src="Sources/CodeIsland/Resources/cli-icons/antigravity.png" width="16"> AntiGravity | 10 | IDE | Full |
| | <img src="Sources/CodeIsland/Resources/cli-icons/workbuddy.png" width="16"> WorkBuddy | 10 | IDE | Full |
| | <img src="Sources/CodeIsland/Resources/cli-icons/hermes.png" width="16"> Hermes | 10 | IDE | Full |
| | <img src="Sources/CodeIsland/Resources/cli-icons/qwen.png" width="16"> Qwen Code | 12 | Terminal | Full |
...
| <img src="docs/images/mascots/kimi.gif" width="28"> | <img src="Sources/CodeIsland/Resources/cli-icons/kimi.png" width="16"> Kimi Code CLI | 12 | Terminal | Full |
